        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastFirst = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsListener = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleIgnorePrefix = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    BookId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NarratorId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookNarrators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookNarrators_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookNarrators_Narrators_NarratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionsBook", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionsBook_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionsBook_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EBookFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EBookFiles_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    BookId = table.Column<Guid>(type: "TEXT", nullable: false),
                    BookmarkTime = table.Column<TimeSpan>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookProgess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookProgess_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBookProgess_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookNarrators_BookId",
                table: "BookNarrators",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookNarrators_NarratorId",
                table: "BookNarrators",
                column: "NarratorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionsBook_BookId",
                table: "CollectionsBook",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionsBook_CollectionId",
                table: "CollectionsBook",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_EBookFiles_BookId",
                table: "EBookFiles",
                column: "BookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookProgess_BookId",
                table: "UserBookProgess",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookProgess_UserId",
                table: "UserBookProgess",
                column: "UserId");
        }
